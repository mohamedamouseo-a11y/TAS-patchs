#!/usr/bin/env bash
set -Eeuo pipefail
BASE="https://raw.githubusercontent.com/mohamedamouseo-a11y/TAS-patchs/main/TAS-SERVICE-CAPACITY-PHASE-4-MAINTENANCE-PLANS-V1"
TMP="$(mktemp -d /tmp/tas-phase4-runner.XXXXXX)"
trap 'rm -rf "$TMP"' EXIT
