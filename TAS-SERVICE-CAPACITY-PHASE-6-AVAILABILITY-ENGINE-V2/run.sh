#!/usr/bin/env bash
set -Eeuo pipefail
BASE="https://raw.githubusercontent.com/mohamedamouseo-a11y/TAS-patchs/main/TAS-SERVICE-CAPACITY-PHASE-6-AVAILABILITY-ENGINE-V2"
TMP="$(mktemp -d /tmp/tas-phase6-runner.XXXXXX)"
trap 'rm -rf "$TMP"' EXIT
