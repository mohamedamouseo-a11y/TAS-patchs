#!/usr/bin/env bash
set -Eeuo pipefail
BASE="https://raw.githubusercontent.com/mohamedamouseo-a11y/TAS-patchs/main/TAS-SERVICE-CAPACITY-PHASE-9-SERVICE-SCHEDULER-V1"
TMP="$(mktemp -d /tmp/tas-phase9-runner.XXXXXX)"
trap 'rm -rf "$TMP"' EXIT
