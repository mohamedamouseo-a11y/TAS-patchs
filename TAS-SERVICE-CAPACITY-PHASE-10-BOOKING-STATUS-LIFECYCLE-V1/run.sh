#!/usr/bin/env bash
set -Eeuo pipefail
BASE="https://raw.githubusercontent.com/mohamedamouseo-a11y/TAS-patchs/main/TAS-SERVICE-CAPACITY-PHASE-10-BOOKING-STATUS-LIFECYCLE-V1"
TMP="$(mktemp -d /tmp/tas-phase10-runner.XXXXXX)"
trap 'rm -rf "$TMP"' EXIT
