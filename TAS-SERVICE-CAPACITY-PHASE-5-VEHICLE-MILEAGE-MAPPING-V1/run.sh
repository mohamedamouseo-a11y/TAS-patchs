#!/usr/bin/env bash
set -Eeuo pipefail
BASE="https://raw.githubusercontent.com/mohamedamouseo-a11y/TAS-patchs/main/TAS-SERVICE-CAPACITY-PHASE-5-VEHICLE-MILEAGE-MAPPING-V1"
TMP="$(mktemp -d /tmp/tas-phase5-runner.XXXXXX)"
trap 'rm -rf "$TMP"' EXIT
